...
{\color{incolor}In [{\color{incolor}66}]:} \PY{k+kn}{import} \PY{n+nn}{os}
...
use the mean)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}67}]:} \PY{n}{mouse} \PY{o}{=} \PY{l+m+mi}{56165}             \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} mouse number id}
         ...
         \PY{n}{session\PYZus{}now} \PY{o}{=} \PY{l+m+mi}{2}              \PY{c+c1}{\PYZsh{}\PYZsh{} session that will run}
...
objects position and timeline
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}68}]:} \PY{n}{file\PYZus{}directory} \PY{o}{=} \PY{n}{os}\PY{o}{.}\PY{n}{environ}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{PROJECT\PYZus{}DIR}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{+} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{neural\PYZus{}analysis/data/calcium\PYZus{}activity/}\PY{l+s+s1}{\PYZsq{}}
...
data trial by trial
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}47}]:} \PY{n}{correlation\PYZus{}matrix} \PY{o}{=} \PY{p}{[}\PY{p}{]}   \PY{c+c1}{\PYZsh{}\PYZsh{} correlation matrix that will contain all the correlation matrix of multiple sessions}
...
conditions for this mouse
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}69}]:} \PY{n}{correlation\PYZus{}fig\PYZus{}path} \PY{o}{=}  \PY{n}{figure\PYZus{}path} \PY{o}{+}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{correlation\PYZus{}matrix\PYZus{}mouse\PYZus{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{+}\PY{n}{f}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+si}{\PYZob{}mouse\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{+}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZus{}session\PYZus{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{+}\PY{n}{f}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+si}{\PYZob{}session\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{+}\PYZbs{}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
/home/sebastian/Documents/Melisa/neural\_analysis/src/figures.py:62: RuntimeWarning: invalid value encountered in log10
...
First define all the files paths, and the load and normalize
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}70}]:} \PY{c+c1}{\PYZsh{} define all relevant files names}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}71}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}load activity and timeline}
         \PY{n}{activity} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{load}\PY{p}{(}\PY{n}{file\PYZus{}directory} \PY{o}{+} \PY{n}{file\PYZus{}name\PYZus{}session\PYZus{}1}\PY{p}{)}
         \PY{n}{timeline\PYZus{}file} \PY{o}{=} \PY{n+nb}{open}\PY{p}{(}\PY{n}{timeline\PYZus{}file\PYZus{}dir} \PY{o}{+} \PY{n}{time\PYZus{}file\PYZus{}session\PYZus{}1}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{rb}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{timeline\PYZus{}info} \PY{o}{=} \PY{n}{pickle}\PY{o}{.}\PY{n}{load}\PY{p}{(}\PY{n}{timeline\PYZus{}file}\PY{p}{)}
         \PY{c+c1}{\PYZsh{}\PYZsh{}normalize neural activity}
...
correlation matrix will be computed and saved in corr\_matrix list.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}72}]:} \PY{c+c1}{\PYZsh{}separate neural activity that belongs to traiing without testing trial}
...
/home/sebastian/anaconda3/lib/python3.6/site-packages/numpy/core/fromnumeric.py:3335: RuntimeWarning: Mean of empty slice.
  out=out, **kwargs)
/home/sebastian/anaconda3/lib/python3.6/site-packages/numpy/core/\_methods.py:154: RuntimeWarning: invalid value encountered in true\_divide
...
/home/sebastian/anaconda3/lib/python3.6/site-packages/numpy/core/\_methods.py:207: RuntimeWarning: invalid value encountered in true\_divide
  ret, rcount, out=ret, casting='unsafe', subok=False)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}73}]:} \PY{c+c1}{\PYZsh{} define file name to save figure and plot}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
/home/sebastian/Documents/Melisa/neural\_analysis/src/figures.py:90: RuntimeWarning: divide by zero encountered in log10
  images.append(axes[i, j].imshow(np.log10(corr\_matrix\_list[i * 2 + j]), cmap='viridis'))
/home/sebastian/Documents/Melisa/neural\_analysis/src/figures.py:90: RuntimeWarning: invalid value encountered in log10
  images.append(axes[i, j].imshow(np.log10(corr\_matrix\_list[i * 2 + j]), cmap='viridis'))
...
distributions.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}74}]:} \PY{c+c1}{\PYZsh{} define file name to save figure and plot}
         ...
         \PY{n}{figs}\PY{o}{.}\PY{n}{plot\PYZus{}correlation\PYZus{}statistics\PYZus{}behaviour}\PY{p}{(}\PY{n}{corr\PYZus{}matrix}\PY{o}{=}\PY{n}{corr\PYZus{}matrix}\PY{p}{,} \PY{n}{path\PYZus{}save}\PY{o}{=}\PY{n}{correlation\PYZus{}stats\PYZus{}path}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
/home/sebastian/anaconda3/lib/python3.6/site-packages/numpy/lib/function\_base.py:2534: RuntimeWarning: invalid value encountered in true\_divide
  c /= stddev[:, None]
/home/sebastian/anaconda3/lib/python3.6/site-packages/numpy/lib/function\_base.py:2535: RuntimeWarning: invalid value encountered in true\_divide
  c /= stddev[None, :]
...
\subsubsection{Days of the experiment}\label{days-of-the-experiment}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}75}]:} \PY{c+c1}{\PYZsh{} Separate neural activity belonging to different days of the experiment, considering as different the resting}
...
lists.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}76}]:} \PY{n}{corr\PYZus{}matrix\PYZus{}days} \PY{o}{=} \PY{p}{[}\PY{p}{]}
         \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{4}\PY{p}{)}\PY{p}{:}
...
Correlation of correlation matrix is simetric while KLD is not!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}77}]:} \PY{c+c1}{\PYZsh{} define the path to save the figure and plot}
...
timeline data, and then compute correlation matrix for each trial.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}78}]:} \PY{c+c1}{\PYZsh{} Separate neural activity for different trials and save in the neural\PYZus{}activity\PYZus{}days and}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}79}]:} \PY{n}{corr\PYZus{}matrix\PYZus{}days} \PY{o}{=} \PY{p}{[}\PY{p}{]}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}80}]:} \PY{c+c1}{\PYZsh{} define figure save path and plot}
...
similar or totaly different in between two trials.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}81}]:} \PY{c+c1}{\PYZsh{} load overlapping information}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}82}]:} \PY{c+c1}{\PYZsh{} define path to save figura and plot}
...
trial correlation matrix analysis.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}83}]:} \PY{c+c1}{\PYZsh{} load the information about object configurations. This files have the configuration vector}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}84}]:} \PY{c+c1}{\PYZsh{}reorder trials acording to conditon (objects configuration)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}85}]:} \PY{c+c1}{\PYZsh{} define path to save figura and plot}
...
analysis are requird (for trial and resting periods).
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}86}]:} \PY{c+c1}{\PYZsh{} define path to save the figure and plot}
